...
export const STAFF_ONBOARDING_MODULES = Object.freeze([
  Object.freeze({
    ...
    order: 1,
    code: "PH",
    documentNumber: "SR-HR-TRN-001",
    revision: "1.0",
    effectiveDate: "2026-08-23",
    owner: "People Operations & Quality",
  ...
  Object.freeze({
    ...
    order: 2,
    code: "WH",
    documentNumber: "SR-QA-TRN-002",
    revision: "1.0",
    effectiveDate: "2026-08-23",
    owner: "Warehouse Operations & Quality",
  ...
  Object.freeze({
    ...
    order: 3,
    code: "PPE",
    documentNumber: "SR-HSE-TRN-003",
    revision: "1.0",
    effectiveDate: "2026-08-23",
    owner: "Health, Safety & Environment",
